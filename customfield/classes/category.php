...
class category {
    ...
    const CLASS_TABLE = 'customfield_category';
    ...
    public function get_count_categories() {
        global $DB;
        return $DB->count_records('customfield_category', array('component' => $this->dataobject->component, 'area' => $this->dataobject->area));
    }
}
